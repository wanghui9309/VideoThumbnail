...
//                                 lineBreakMode:NSLineBreakByTruncatingTail];
                ...
                CGSize size = [ms boundingRectWithSize: viewSize options: NSStringDrawingUsesLineFragmentOrigin attributes: @{NSFontAttributeName : _subtitlesLabel.font} context: nil].size;
